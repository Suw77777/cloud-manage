...
require (
	...
	github.com/alibabacloud-go/oss-20190517 v1.0.1
	github.com/alibabacloud-go/sls-20201230/v2 v2.0.13
...
require (
	...
	github.com/alibabacloud-go/vpc-20160428/v3 v3.0.1 // indirect
